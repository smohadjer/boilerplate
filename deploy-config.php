...
define('TARGET_DIR', '/var/www/vhosts/boilerplate.saeidmohadjer.com/app/');
...
define('TMP_DIR', '/var/www/vhosts/boilerplate.saeidmohadjer.com/app/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
