...
define('REMOTE_REPOSITORY', 'https://github.com/smohadjer/boilerplate.git');
...
define('TARGET_DIR', '/var/www/vhosts/saeidmohadjer.com/boilerplate/');
...
define('TMP_DIR', '/var/www/vhosts/saeidmohadjer.com/biolerplate/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
